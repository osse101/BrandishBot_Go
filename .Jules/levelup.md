...
- **Lootbox "God Roll"**: Identified a missed opportunity for celebration when a player receives multiple Legendary items in a single lootbox. Added `EventLootboxGodRoll` (2+ Legendaries) to distinguish this ultra-rare moment from a standard "Jackpot" (1 Legendary), providing clearer feedback for extreme luck.
