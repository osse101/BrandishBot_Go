...
func (_m *MockRepository) GetChildNodes(ctx context.Context, parentID int) ([]*domain.ProgressionNode, error) {
...
// MockRepository_GetChildNodes_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetChildNodes'
type MockRepository_GetChildNodes_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - parentID int
func (_e *MockRepository_Expecter) GetChildNodes(ctx interface{}, parentID interface{}) *MockRepository_GetChildNodes_Call {
	return &MockRepository_GetChildNodes_Call{Call: _e.mock.On("GetChildNodes", ctx, parentID)}
}

func (_c *MockRepository_GetChildNodes_Call) Run(run func(ctx context.Context, parentID int)) *MockRepository_GetChildNodes_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockRepository_GetChildNodes_Call) Return(_a0 []*domain.ProgressionNode, _a1 error) *MockRepository_GetChildNodes_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRepository_GetChildNodes_Call) RunAndReturn(run func(context.Context, int) ([]*domain.ProgressionNode, error)) *MockRepository_GetChildNodes_Call {
	_c.Call.Return(run)
	return _c
}
