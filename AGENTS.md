...
| ---------------------------------- | ------------------------------------------------------------------------------------- |
| **Need to check/run migrations**   | View **[Goose Skill](docs/database/MIGRATIONS.md)**                                   |
| **Need to inspect database**       | View **[Postgres Skill](docs/database/DATABASE.md)**                                  |
| **Need to run tests**              | View **[Testing Skill](docs/testing/TEST_GUIDANCE.md)**                               |
| **Need to deploy/rollback**        | View **[Deploy Workflow](docs/deployment/DEPLOYMENT_WORKFLOW.md)**                    |
| **Need to fix linter errors**      | View **[Lint-Fix Workflow](docs/development/CODE_QUALITY_RECOMMENDATIONS.md)**        |
| **Need to refactor a service**     | View **[Refactor-Service Workflow](docs/development/FEATURE_DEVELOPMENT_GUIDE.md)**   |
| **Need to add an API endpoint**    | View **[Add-Endpoint Workflow](docs/development/FEATURE_DEVELOPMENT_GUIDE.md)**       |
| **Need to create Discord command** | View **[Discord Skill](docs/discord/command-registration.md)**                        |
| **Need to modify progression**     | View **[Progression Skill](docs/development/PROGRESSION_GUIDANCE.md)**                |
