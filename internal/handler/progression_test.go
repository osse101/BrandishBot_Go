...
func TestProgressionHandlers_HandleVote(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "Success",
			body: VoteRequest{Platform: "discord", PlatformID: "u1", NodeKey: "n1"},
			setupMock: func(m *mocks.MockProgressionService) {
				m.On("VoteForUnlock", mock.Anything, "discord", "u1", "n1").Return(nil)
			},
		...
		},
		{
			...
			body:           VoteRequest{Platform: "discord", PlatformID: "", NodeKey: "n1"},
			setupMock:      func(m *mocks.MockProgressionService) {},
		...
		},
		{
			...
			body: VoteRequest{Platform: "discord", PlatformID: "u1", NodeKey: "n1"},
			setupMock: func(m *mocks.MockProgressionService) {
				m.On("VoteForUnlock", mock.Anything, "discord", "u1", "n1").Return(errors.New("already voted"))
			},
