...
- **Example**: User crafts an item.
  - _Core Logic_: Deduct materials, add item.
  - _Side Effect 1_: Grant XP (Progression).
  - _Side Effect 2_: Check "Master Crafter" achievement.
  - _Side Effect 3_: Log analytic event.
  - _Side Effect 4_: Notify Discord channel (if rare item).
